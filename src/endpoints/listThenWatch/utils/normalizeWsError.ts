...
const readString = (value: unknown): string | undefined => (typeof value === 'string' && value.trim().length > 0 ? value : undefined)
...
export const normalizeWsError = (error: unknown, fallbackUserMessage = 'Initial list failed'): TNormalizedWsError => {
