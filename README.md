...
| `BASE_NAVIGATION_RESOURCE_NAME`          | `string` | Resource plural name for navigation settings. `navigations` |
| `BASE_NAVIGATION_RESOURCE`               | `string` | Resource name for navigation settings. `navigation`         |
